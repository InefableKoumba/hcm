...
export default function DonationPage() {
  ...
  const handleDonation = (e: React.FormEvent) => {
    ...
    alert(
      `Merci ${donorName} pour votre don de ${parseInt(
        donationAmount
      ).toLocaleString(
        "fr-FR"
        ...
        <div className="container mx-auto px-6 max-w-4xl py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Votre générosité permet d'améliorer la mobilité et l'inclusion des
              personnes en situation de handicap au Congo. Chaque contribution
              compte.
            </p>
          </div>
            ...
            <form onSubmit={handleDonation} className="space-y-8">
              ...
              <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-sm text-gray-600">
                  ...
                  ne stockons jamais vos données bancaires.
                </p>
              </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              Votre don contribue directement à l'amélioration de la mobilité et
              de l'inclusion des personnes en situation de handicap au Congo.
            </p>
          </div>
        </div>
      </div>
