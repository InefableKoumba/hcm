  ...
  const testimonials = [
    {
      ...
      role: 'Bénéficiaire',
      content:
        "Grâce à HandiMobilité Congo, j'ai pu obtenir un fauteuil roulant adapté. Ma vie a complètement changé, je peux maintenant me déplacer librement.",
      icon: User,
      color: '#00a86b',
    },
    {
      ...
      role: 'Parent',
      content:
        "L'accompagnement de HMC a permis à mon fils d'accéder à l'éducation. L'école est maintenant accessible et il peut suivre ses cours normalement.",
      icon: UserCircle,
      color: '#0052a3',
    },
    {
      ...
      role: 'Bénéficiaire',
      content:
        "Les formations professionnelles m'ont aidée à trouver un emploi. Je suis maintenant autonome financièrement et fière de contribuer à la société.",
      icon: Briefcase,
      color: '#00a86b',
    },
  ]
  ...
  return (
    <section className="section bg-gradient-hero text-white">
      <div className="container mx-auto px-6 max-w-7xl">
        <h2
          className="section-title animate-fade-in text-white"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          {testimonials.map((testimonial, index) => {
            ...
            return (
              ...
              >
                {/* Quote icon */}
                <div className="absolute top-4 left-4 text-white/20 text-6xl font-serif leading-none">
                  &quot;
                </div>
