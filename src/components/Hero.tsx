...
import { ChevronDown, Heart, Users, Target, ArrowRight } from 'lucide-react'
    ...
    >
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-20">
        <div className="text-center text-white max-w-5xl mx-auto">
          ...
          >
            Contribuons ensemble à la pleine inclusion des personnes en situation de handicap dans
